...
echo -e "🌐 统一入口: http://localhost:8080 (Nginx代理)"
echo -e "📊 管理后台: http://localhost:7101 (Nginx代理) 或 http://localhost:3001 (容器直连) 或 http://localhost:3004 (IDE直连)"
echo -e "🚀 DApp应用: http://localhost:7102 (Nginx代理) 或 http://localhost:3002 (容器直连) 或 http://localhost:3005 (IDE直连)"
echo -e "🏠 官网首页: http://localhost:7103 (Nginx代理) 或 http://localhost:3003 (容器直连) 或 http://localhost:3006 (IDE直连)"
echo -e "🔧 后端API: http://localhost:8888/api/ (容器直连) 或 http://localhost:8889/api/ (IDE直连) 或通过上述代理端口"
echo -e "📚 Swagger UI: http://localhost:8888/swagger-ui/ (容器直连) 或 http://localhost:8889/swagger-ui/ (IDE直连) 或通过上述代理端口"

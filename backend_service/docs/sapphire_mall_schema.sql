...
CREATE TABLE `sys_order`  (
  ...
  `sku_imgs` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'sku图片',
  ...
  `total_amount` decimal(12, 2) NOT NULL DEFAULT 0.00 COMMENT '商品总金额（单价×数量）',
  ...
  `discount_amount` decimal(12, 2) NOT NULL DEFAULT 0.00 COMMENT '促销减免合计',
  ...
  `act_gas_fee` decimal(12, 2) NOT NULL DEFAULT 0.00 COMMENT '实际Gas费',
  `pay_amount` decimal(12, 2) NOT NULL DEFAULT 0.00 COMMENT '实付金额(含预估gas费)',
  `real_amount` decimal(12, 2) NOT NULL DEFAULT 0.00 COMMENT '实付金额(含实际gas费)',

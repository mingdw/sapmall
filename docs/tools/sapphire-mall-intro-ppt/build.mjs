/**
 * 生成 Sapphire Mall 项目介绍 PPTX（内容对齐 README / PRD / Roadmap）。
...
const PLATFORM_INTRO_BODY =
  "Sapphire Mall 是基于区块链的虚拟商品交易平台，支持主流稳定币与平台通证 SAP 作为主要支付手段；以 DAO 推动社区共建共治，让买家、创作者与社区贡献者等不同角色互惠共赢、共享平台价值。生态活动与奖励在 DApp 内独立聚合，与商城结账路径分离，便于迭代营销玩法而不干扰主交易架构。";
...
addBullets("生态活动与边界", [
  "问题：若把全部营销活动塞进购物车与 SAP 主合约路径，迭代成本高且易混淆活动资产与主代币。",
  "入口统一：DApp 内活动、奖励说明聚合在「/rewards（生态活动）」；「/marketplace」专注选品与下单，不承担活动主入口。",
]);
...
addBullets("功能清单（与 README 路由对齐）", [
  "sapmall-dapp：/marketplace 代币化商品商城；/exchange 兑换与资产；/rewards 生态活动聚合；/dao 社区与治理；/help 帮助；内嵌 /admin 管理后台。",
...
addBullets("建议演示顺序", [
  ...
  "进入 /rewards 展示生态活动与奖励规则，强调与结账路径分离。",
  "DAO / 帮助页：治理叙事与 FAQ。",
]);
...
addTitleSlide("谢谢", "详细文档见仓库 docs/（PRD、白皮书、Tokenomics、Roadmap）");
